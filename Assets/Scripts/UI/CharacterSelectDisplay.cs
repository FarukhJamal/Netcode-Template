...
public class CharacterSelectDisplay : NetworkBehaviour
{
    ...
    private List<CharacterSelectButton> charactersButton = new List<CharacterSelectButton>();
    ...
    public override void OnNetworkSpawn()
    {
        if (IsClient)
        {
            ...
            {
                var selectedButtonInstance = Instantiate(selectButtonPrefab, characterHolder);
                selectedButtonInstance.SetCharacter(this,character);
                charactersButton.Add(selectedButtonInstance);
            }
    ...
    private void HandlePlayersStateChanged(NetworkListEvent<CharacterSelectState> changeEvent)
    {
        ...
        foreach (var button in charactersButton)
        {
